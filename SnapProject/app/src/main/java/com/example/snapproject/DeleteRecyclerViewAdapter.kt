...
import com.example.snapproject.databinding.ItemDeleteProductBinding
...
class DeleteRecyclerViewAdapter(
    ...
    // ViewHolder 클래스
    inner class ViewHolder(private val binding: ItemDeleteProductBinding) :
        ...
        fun bind(listItemData: ListItemData) {
            ...
            binding.apply {
                ...
                checkboxDelete.isChecked = listItemData.isDeleteChecked

                checkboxDelete.setOnCheckedChangeListener { _, isChecked ->
                    listItemData.isDeleteChecked = isChecked
                }
            }
    ...
    override fun onCreateViewHolder(
        ...
        return ViewHolder(
            ItemDeleteProductBinding.inflate(LayoutInflater.from(parent.context), parent, false),
        )
    }
